...
function WebViewReciclador(props) {
  const webviewRef = React.useRef(null);

  function webViewgoback() {
    if (webviewRef.current) props.navigation.navigate("SelecionarPerfil");
  }
  ...
  return (
    <>
      <SafeAreaView style={styles.flexContainer}>
        <WebView
          source={{ uri: "https://app.uzeh.com.br/uzeh-admin/newuser/reciclador" }}
...
export default WebViewReciclador;