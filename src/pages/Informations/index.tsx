...
import Scheduled from 'pages/Informations/scheduled';
...
import Canceled from 'pages/Informations/canceled';
...
const Informations: FCWithLoggedStackNavigator<'Informations'> = ({
  navigation: {navigate},
}) => {
      ...
      <Background horizontal vertical>
        <Container pb>
          ...
          <Container
            ...
            <Title style={{alignSelf: 'center'}}>Suas Informações</Title>
          </Container>
        </Container>
        <Container
          style={{
...
export default withAppbar(Informations);
